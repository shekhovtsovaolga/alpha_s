...
# Quark charges
def quark_charge():
    return {'q_u': 2./3.,  'q_s': 2./3.,  'q_b': 2./3,
            'q_d': -1./3., 'q_c': -1./3,  'q_t': -1./3.}
...
#
def n_f(s, fixed_3=False, nf_low_3=True):
    m_u = quark_mass()['m_u']
    m_s = quark_mass()['m_s']
    m_c = quark_mass()['m_c']
    m_b = quark_mass()['m_b']
...
#
def beta_0(s, fixed_3=False, nf_low_3=True):
    return 11. - 2./3.*n_f(s, fixed_3, nf_low_3)

# arXiv:1604.08082, Eq. (4.54)
def funct_alpha_0(s, lambda1=0.3, fixed_3=False, nf_low_3=True):
    f = lambda1**2/(lambda1**2 - s) + 1./log(s/lambda1**2)
    return 4.*pi/beta_0(s, fixed_3, nf_low_3)*f

# arXiv:0611229, Eq. (2.14)
def funct_alpha_1(s, lambda1=0.3, fixed_3=False, nf_low_3=True):
    L1 = log(s / lambda1 ** 2)
    return 4./(beta_0(s, fixed_3, nf_low_3))*arccos(L1/sqrt(L1**2 + pi **2))

def funct_alpha(s, alpha_order=0,  lambda1=0.3, fixed_3=False, nf_low_3=True):
    if alpha_order==0:
...
def funct_r_f(m_f, q_f, s, alpha_order=0, lambda1=0.3,fixed_3=False, nf_low_3=True, a=0.2):
    return 3.*q_f**2*funct_t(m_f, s)*(funct_s(m_f, s, a) +
                             funct_alpha(s, alpha_order, lambda1, fixed_3, nf_low_3) * funct_g(m_f, s) -
                             funct_x(m_f, s, a)/2. )
    
def funct_r(s, alpha_order=0, lambda1=0.3, fixed_3=False, nf_low_3=True, a=0.2):
    m_u = quark_mass()['m_u']
    m_d = quark_mass()['m_d']
    m_s = quark_mass()['m_s']
    m_c = quark_mass()['m_c']
...
def d_amu_s(s,  s_limit_1=40000, alpha_order=0, lambda1=0.3, fixed_3=False, nf_low_3=True, a=0.2,
            integral=True):
    m_mu = 0.1057
    alpha = 1./137.
    m_pi = 0.139
...
def amu_s1_s2(method, s1, s2, s_limit_1=40000, alpha_order=0, lambda1=0.3, fixed_3=False, nf_low_3=True, a=0.2,
              integral=True):
...
def d_amu_s_quark_f(f, s, s_limit_1=40000, alpha_order=0, lambda1=0.3, fixed_3=False, nf_low_3=True, a=0.2,
                    integral=True):
...
def amu_s1_s2_quark_f(method, f, s1, s2, s_limit_1=40000, alpha_order=0, lambda1=0.3, fixed_3=False, nf_low_3=True,
                      a=0.2, integral=True):
...
def d_amu_s_quark_total(s, s_limit_1=40000, alpha_order=0, lambda1=0.3, fixed_3=False, nf_low_3=True, a=0.2,
                        integral=True):
...
def amu_s1_s2_quark_total(method, s1, s2, s_limit_1=40000, alpha_order=0, lambda1=0.3, fixed_3=False, nf_low_3=True,
                          a=0.2, integral=True):
...
def integrand_high_energy(t, alpha_order=0, lambda1=0.3, fixed_3=False, nf_low_3=True, a=0.2):
    m_mu = 0.1057
    alpha = 1. / 137.
    m_pi = 0.139
    return funct_r(1./t, alpha_order, lambda1, fixed_3, nf_low_3, a)*(alpha*m_mu/3./pi)**2

def amu_high_energy_estimation(method, t_max, alpha_order=0, lambda1=0.3, fixed_3=False, nf_low_3=True, a=0.2, t_min=0):
